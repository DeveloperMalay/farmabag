...
Map<String, dynamic> discountOnPtrOnly(PtrOnlyModel data) {
  ...
  if (maxQtySale > userBuy) {
    return {
      "status": false,
      "message": "maxQtySale should be less than $maxQtySale"
    };
    ...
    return {
      ...
      "message": "You have got $discountOnPtrOnlyPercenatge% discount"
    };
  } else {
    return {
      "status": false,
      "message": "minQtySales should be greater than $minQtySale"
    };
  }
}
